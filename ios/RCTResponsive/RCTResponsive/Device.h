...
// RCTBridgeModule seront ajoutées dans la définition de Device (les méthodes @required (modifier protocole par défaut) du protocole doivent être implémentées obligatoirement
