...
class Device {
	...
	static dpHeight = Math.max(Dimensions.get("window").height, Dimensions.get("window").height);
	static pxWidth = Math.min(Dimensions.get("window").width, Dimensions.get("window").width) * PixelRatio.get();
